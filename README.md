...
- **Memory Layer (`.specify/memory/`)**:
  ...
  - `projects/{Project}/` — isolated per-project `project.md`, `tech-stack.md`, `coding-standards.md`
...
The complete directory layout a SpecKit workspace produces — the `/sk.init` memory layer and one fully-walked unit through all seven phases:
