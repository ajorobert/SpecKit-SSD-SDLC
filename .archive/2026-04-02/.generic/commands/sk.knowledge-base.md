...
Read these files based on tier:

Tier system:
- .specify/memory/system-context.md
- history/adr/ (scan all)

Tier domain:
- specs/domains/{domain}/knowledge-base.md (if exists)
- history/adr/ (scan for domain-tagged ADRs)

Tier unit:
- specs/intents/{intent}/units/{unit}/architecture.md
- history/adr/ (scan for unit-tagged ADRs)
