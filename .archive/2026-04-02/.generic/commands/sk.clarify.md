...
4. After user answers: record in working memory, then immediately:
   ...
   - Apply the clarification to the appropriate section in story-{ID}.md
...
- If clarification changes scope: flag to user, suggest updating story status
- Checkpoint re-classification may be needed if scope changed significantly
