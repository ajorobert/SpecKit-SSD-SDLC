---
name: sk.datamodel
description: "Invoke when: designing data entities, schema strategy, and access patterns for a unit. Role: architect. Reads: architecture.md, domain-model.md, data-standards.md. Writes: data-model.md, domain-model.md (updated)."
