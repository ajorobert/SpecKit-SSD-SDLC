...
## Guide System
Three-tier routing index alongside code and knowledge bases.

Tier 1 — system:  specs/guide.yaml
Tier 2 — domain:  specs/domains/{domain}/guide.yaml
Tier 3 — unit:    specs/intents/{intent}/units/{unit}/guide.yaml

Auto-generated by sk.design.
Read first to know where to look before loading knowledge bases.
