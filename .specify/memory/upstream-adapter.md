Upstream Adapter Map
Always reference by file path. Never use slash command names.
If any path returns not-found: STOP, report to user, run reconcile-upstream.sh
