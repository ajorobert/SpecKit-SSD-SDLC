---
name: sk.hotfix
description: "Invoke when: P0 incident fast path — emergency fix to production. Role: lead. Reads: session.yaml, 01-story/, 02-design/architecture.md. Writes: 03-plan/{Project}/plan.md, 04-implementation/{Project}/, src/**. 3-gate: plan → implement → ship (no full spec cycle)."
