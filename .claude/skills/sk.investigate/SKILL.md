---
name: sk.investigate
description: "Invoke when: debugging a story, finding root causes, or classifying bugs as implementation bugs vs spec/contract mismatches. Role: backend or frontend (required). Reads: stories/, 02-design/api-spec.json, 03-plan/{Project}/plan.md. Writes: 04-implementation/{Project}/investigation-report.md, 02-design/knowledge-base.md (candidate invariants)."
